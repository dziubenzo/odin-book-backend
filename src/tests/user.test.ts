...
import { defaultAvatars } from '../config/helpers';
    ...
    it('should return a 200 and a user object with stats properties', async () => {
      await request(app)
        ...
        .expect((res) => {
          ...
          expect(res.body.postDislikesCount >= 0).toBeTruthy();
          expect(res.body).toHaveProperty('commentsCount');
          expect(res.body.commentsCount >= 0).toBeTruthy();
          expect(res.body).toHaveProperty('commentLikesCount');
          expect(res.body.commentLikesCount >= 0).toBeTruthy();
          expect(res.body).toHaveProperty('commentDislikesCount');
          expect(res.body.commentDislikesCount >= 0).toBeTruthy();
